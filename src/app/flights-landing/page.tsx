...
import TopRatedProviders from '@/components/flights/TopRatedProviders';
  ...
  return (
    <>
      <section
        ...
        style={{
          background:
            "linear-gradient(45deg, black, transparent), url('/images/flight_banner.png')",
              ...
              <div className="col-md-12 mx-auto wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div className="banner-form card mb-0">
                  <div className="card-header">
                    <ul className="nav">
                      <li>
                        <Link href="/flights-landing" className="nav-link active">
            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-lg-6">
                        <div>
                            <h2 className="mb-2">Where comfort meets elegance and every guest is treated like family.</h2>
                            <p>Our mission is to create memorable experiences for our guests. We believe that every stay should
                                feel special, whether you’re here for business, leisure, or a special occasion.
                            </p>
                        </div>
                    </div>
                    <div className="col-lg-6">
                        <div className="flight-about d-lg-flex align-items-center flex-fill">
                                <Image src="/images/about.svg" alt="img" width={546} height={226} />
                                <div className="flight-bg">
                                    <Image src="/images/flight-bg.png" alt="img" width={491} height={491} />
                                </div>
                            </div>
                    </div>
                </div>
